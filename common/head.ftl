<head>
    ...
    <meta property="og:title" content="${blog_title!} - ${blog_title!}">
    <meta property="og:image" content="${theme_base!}/source/images/b.jpg">
    ...
    <link rel="icon" href="${blog_favicon!}" sizes="32x32">
    <link rel="icon" href="${blog_favicon!}" sizes="192x192">
